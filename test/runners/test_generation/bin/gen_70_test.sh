...
TEST_YML="${TEST_DEFS}/0100_standard/070_zelta_prune_test.yml"
...
SHELLSPEC_SETUP=--setup="shellspec --tag=install,initialize,standard:22,standard:30,standard:40,standard:50,standard:60"
