...
---
> - **What's New:** Check [CHANGELOG.md](https://github.com/bell-tower/zelta/blob/main/CHANGELOG.md) for the latest changes
...
[zelta.space](https://zelta.space) | [Documentation](https://zelta.space/docs/home/) | [GitHub](https://github.com/bell-tower/zelta)
...
Zelta 1.2.0 adds the prune planner/`zprune` split, rebase, failover, lock/unlock, propsync, snapshot thresholds, policy imports, replication-success bookmarks, and broader include/exclude filtering. See [CHANGELOG.md](https://github.com/bell-tower/zelta/blob/main/CHANGELOG.md) for release details and current known issues.
